 ...
 */
@WebServlet("/Kefu3")
public class Kefu3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		kefu_jilu_list=Test.getKefu_jiluByUser_id(id);
	    
		request.setAttribute("kefu_jilu_list",kefu_jilu_list);
		
		request.getRequestDispatcher("admin/chat_main.jsp").forward(request, response);
	}
