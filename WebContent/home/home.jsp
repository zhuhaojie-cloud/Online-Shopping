...
function sousuo(){
	 ...
	 alert(document.getGetElementById('search_choose').innerHTML);
...
<body>
<div id="touxiang" style="width:100%;height:400px;position:fixed;z-index:10;top:30px;display:none;border-radius: 5px;padding:40px;">
    <div style="border-radius:15px;background-color:#ccc;width:600px;margin:0 auto;height:100%;position:relative;">
     <form id="uploadForm" action="${pageContext.request.contextPath}/Tou" method="post" name="tou" enctype="multipart/form-data">
		...
		<center style="height:150px"><img src="" alt="" id="selectImg" style="width:100px;height:100px;margin-top:10px;"></center>
		<div class="bt_box">
        ...
        <div id="close" style="position:absolute;right:0px;top:0px;border-radius:50%;width:30px;height:30px;">
           <img src="${pageContext.request.contextPath}/images/error.jpg" style="border-radius:50%;width:100%;height:100%">
        </div>
    </div>
</div>
  ...
  <div style="width:100%;height:36px;position:fixed;display:none;z-index:999;background:#fcaadd;" id="search_gu">
    ...
    <div style="border:1px solid #dd00a7;width:529px;margin:0 auto;">
              <div style="float:left;position: absolute;margin:0 auto">
                <div onmouseenter="my16mouseenter()" onmouseleave="my16mouseleave()" style="border-right:1px solid #dd00a7;height:27px;padding:3px 10px 3px 20px;"><p style="float:right">&#9660;</p><p id="search_choose1" style="float:left">商品</p></div>
              ...
              <div>
              <form style="margin:0;padding:0;" name="form2" action="${pageContext.request.contextPath}/Sousuo">
               <input type="text" style="display:none" id="sousuo_leis1" name="sousuo_lei" value="商品">
    ...
    <div style="position:fixed;width: 35px;height: 100%;top: 0;right: 0;background: #5c5c5c;z-index: 998;">
      ...
      <div id="deng" class="ce_deng" style="cursor:pointer;width:100%;height:35px;background: #cdd;border-bottom: 1px solid #fff;margin-top:200px;"><img alt="登陆" src="images/login_user.png" style="width:35px;height:35px;"></div>
     
      <div class="ce_guwuche" style="cursor:pointer;width:80%;height:100px;background: #fff;border-bottom: 1px solid #cdd;text-align: center;padding:5px"><a href="${pageContext.request.contextPath}/Gouwuche1" target="_blank">购物车</a><img src="images/gouwuche.png" style="width:28px;height:28px"></div>
      
      <div id="shoucang" style="cursor:pointer;width:100%;height:35px;background: #fff;border-bottom: 1px solid #f8f8f8;"><img alt="" src="images/shoucang.png" style="padding:5px;width:28px;height:28px;"></div>
      
    </div>
    <div style="transition:right .5s ease 0s;position:fixed;width:240px;height: 100%;top: 0;right: -275px;background:#fff;z-index: 997;box-shadow: 0 0 20px rgba(0,0,0,.19);" id="self" >
       <div style="margin:50px 0 20px 10px;cursor:pointer" id="yincang">>>>个人信息</div>
       <div style="width:120px;height:120px;margin:0 auto">
         <%if(user.getImage()==""){%>
          <img id="tou" src="${pageContext.request.contextPath}/" style="cursor:pointer;border-radius: 50%width:100%;height:100%">
         <%}else{ %>
           <img id="tou" src="${pageContext.request.contextPath}/<%=user.getImage() %>" style="cursor:pointer;width:100%;height:100%;border-radius: 50%">
         <%} %>
         <p style="text-align: center"><%=user.getUserName() %></p>
         <%if(user.getMenber_id()==0){ %>
         <p style="text-align: center">非会员</p>
         <%}else{
        	 Menber_mode menber=Test.getMenber_modeById(user.getMenber_id());
        	 %>
          <p>
             <%=menber.getMenber_mode_name() %>
          </p>
         <%} %>
       </div>
       <div style="width:220px;height:80px;margin:0 auto;padding-top:50px;">
         <a href=""><p>优惠卷 <span style="margin-left:10px;font-weight:700;color:#747474;font-size:14px;"> <%=juan_count %></span></p></a>
       </div>
       <div style="">
       <div style="height:30px;width:220px;margin:0 auto;">
          <p style="float:left;color:#5e5e5e;font-size: 13px;">会员权益详情</p>
          <p style="float:right;color:#5e5e5e;font-size: 13px;">我的3项权益</p>
       </div>
       <div style="margin:0 auto;width:200px">
       <div style="float:left;width:65px;height:85px">
          <a><img src="${pageContext.request.contextPath}/images/home_choujiang.png" style="width:55px;height:55px"></a>
          <a href="" style="font-size: 13px">退货保障</a>
       </div>
        <div style="float:left;width:65px;height:85px">
          <a><img src="${pageContext.request.contextPath}/images/home_shengri.png" style="width:55px;height:55px"></a>
          <a href="" style="font-size: 13px">价格保护</a>
       </div>
        <div style="float:left;width:65px;height:85px">
          <a><img src="${pageContext.request.contextPath}/images/home_shengri.png" style="width:55px;height:55px"></a>
          <a href="" style="font-size: 13px">生日礼包</a>
       </div>
        <div style="float:left;width:65px;height:85px">
          <a><img src="${pageContext.request.contextPath}/images/home_shengri.png" style="width:55px;height:55px"></a>
          <a href="" style="font-size: 13px">天狗抽奖</a>
       </div>
        <div style="float:left;width:65px;height:85px">
          <a><img src="${pageContext.request.contextPath}/images/home_gengduo.png" style="width:55px;height:55px"></a>
          <a href="" style="font-size: 13px">更多精彩</a>
       </div>
       </div>
       <div style="margin:0 auto;width:200px;text-align:center;margin-top:300px">
                        <a href="${pageContext.request.contextPath}/login/login.jsp">退出登录</a>
                        
       </div>
       </div>
    </div>
    <div style="transition:right .5s ease 0s;position:fixed;width:240px;height: 100%;top: 0;right: -275px;background:#fff;z-index: 997;box-shadow: 0 0 20px rgba(0,0,0,.19);" id="shoucang_lan" >
       <div style="margin:50px 0 20px 10px;cursor:pointer" id="yincang1">>>>我的收藏</div>
       <div id="shoucang_shangpin" style="cursor:pointer;padding-top:10px;font-size:14px;text-align:center;border:1px solid #e6e6e6;float:left;width:78px;height:30px;margin-top:20px;color:#f5004b;border-bottom:2px solid #f5004b; ">商品</div>
       <div id="shoucang_dianpu" style="cursor:pointer;padding-top:10px;font-size:14px;text-align:center;border:1px solid #e6e6e6;float:left;width:78px;height:30px;margin-top:20px;color:#f5004b;border-bottom:2px solid #f5004b; ">店铺</div>
       <div id="shoucang_pinpai" style="cursor:pointer;padding-top:10px;font-size:14px;text-align:center;border:1px solid #e6e6e6;float:left;width:78px;height:30px;margin-top:20px;color:#f5004b;border-bottom:2px solid #f5004b; ">品牌</div>
       <div id="shoucang_shangpin_lan" style="width:200px;margin:0 auto;padding-top:80px">
          <div style="font-size:14px;width:200px;height:25px;text-align: center;padding-top:5px;background: #f3f3f3;border: 1px solid #e6e6e6;border-radius: 3px;">全部</div>
           <%if(!shoucang_shangpin_list.isEmpty()){
            ...
            %>
           <div onmouseenter="my_2<%=map.getId() %>mouseenter()" onmouseleave="my_2<%=map.getId() %>mouseleave()" style="float:left;width:100px;height:130px;text-align:center;position: relative;">
             <a href="${pageContext.request.contextPath}/Delete?action=home_shoucang_shangpin&id=<%=map.getId()%>"><div id="shoucang_shangpin_error<%=map.getId() %>" style="cursor:pointer;display:none;position: absolute;top:0px;right:0"><img src="${pageContext.request.contextPath}/images/error.jpg" style="width:15px;height:15px"></div></a>
             <div id="shoucang_shangpin_jiaru<%=map.getId() %>" style="display:none;width:100px;text-align:center;position: absolute;opacity:0.7;bottom:15px;background:#c8c8c8"><a href="${pageContext.request.contextPath}/Shangpin?commodity_id=<%=map.getCommodity_id()%>">加入购物车</a></div>
             <div style="font-size:12px;"><%=map.getTime() %></div>
             <a href="${pageContext.request.contextPath}/Shangpin?commodity_id=<%=map.getCommodity_id()%>">
               <img src="${pageContext.request.contextPath}/<%=commodity_infor.getImage() %>" style="width:80px;height:80px;">
               <p style="font-size:13px;font-weight:700;line-height: 14px;color: #ff0027;">￥<%=commodity_infor.getPrice() %>  </p>
             </a>
           </div>
          <%}} %>
           <div style="margin-top:400px;font-size:14px;width:200px;height:25px;text-align: center;padding-top:5px;background: #f3f3f3;border: 1px solid #e6e6e6;border-radius: 3px;">
              <a>查看更多藏品</a>
           </div>
       </div>
       <div id="shoucang_dianpu_lan" style="width:200px;margin:0 auto;padding-top:80px;display: none;">
          <div style="font-size:14px;width:200px;height:25px;text-align: center;padding-top:5px;background: #f3f3f3;border: 1px solid #e6e6e6;border-radius: 3px;">全部</div>
          
          
          <div style="width:200px;height:140px;margin-top:10px;">
            <div style="font-size:12px;text-align: center">2019-11-15 22:00:34</div>
            <a href="">
             <img src="${pageContext.request.contextPath}/images/dianpu1.png" style="width:200px;height:120px;">
             <p style="padding-top:5px;height:20px;border-radius: 3px;background: #f3f3f3;text-align:center;margin:0 auto;width:60px;font-size: 13px;font-weight: 700;line-height: 14px;color: #ff0027;">进入店铺</p>
            </a>
          </div>
          
           <div style="margin-top:300px;font-size:14px;width:200px;height:25px;text-align: center;padding-top:5px;background: #f3f3f3;border: 1px solid #e6e6e6;border-radius: 3px;">
              <a>查看更多收藏店铺</a>
           </div>
       </div>
       <div id="shoucang_pinpai_lan" style="width:200px;margin:0 auto;padding-top:80px;display: none;">
         <!--  <div style="font-size:14px;width:200px;height:25px;text-align: center;padding-top:5px;background: #f3f3f3;border: 1px solid #e6e6e6;border-radius: 3px;">全部</div>
          <div style="font-size:12px;">时间</div>
           <div style="float:left;width:100px;height:100px;text-align: center">
            <a href="">
             <img src="" style="width:80px;height:80px;">
             <p style="font-size: 13px;font-weight: 700;line-height: 14px;color: #ff0027;">￥ 222</p>
            </a>
           </div>
	    	  ...
	    	  for(Notice_infor map:notice_infor_list){ %>
                ...
                <div style="width:100%;height:35%">
                   <ul style="list-style:none;margin:0;padding:0;height:100%">
                     ...
                     <li style="width:50%;height:50%;float:left;"><img src="${pageContext.request.contextPath}/images/home_huiyuan.png" style="width:100%;height:100%;"><li>
                     <li style="width:50%;height:50%;float:left;"><a href="${pageContext.request.contextPath}/Lingjuanzhongxin" target="_blank"><img src="${pageContext.request.contextPath}/images/home_lingjuan.png" style="width:100%;height:100%;"></a><li>
                   </ul>
                </div>
                <div style="width:100%;height:35%">
...
<%if(!coupon_list.isEmpty()){
      List<Lingjuan> lingjuan_list=new ArrayList<Lingjuan>();
      lingjuan_list=Test.getLingjuanByUser_id(user_id);
            	/*Random r = new Random(1);*/
            		  /*int ran1 = r.nextInt(coupon_list.size());*/
      int i=1;
	  for(Coupon map:coupon_list){
		 ...
		 if(i==5) break;
	       ...
	       if(!lingjuan_list.isEmpty()){
	    	 for(Lingjuan map1:lingjuan_list){
	    		if(map.getId()!=map1.getCoupon_id()){
	    			t=1;//未
	    		}else{
	    			t=0;//已
	    		}
...
%>
           <div style="width:320px;height:100px;">
              <div style="height:100px;width:220px;float:right;">
                <div style="float:right;width:20%;height:100%;padding-top:10px;">
                   <a href="${pageContext.request.contextPath}/Lingjuan1?action=home&id=<%=map.getId() %>" style="display:inline-block;vertical-align: middle;line-height: 19px;width: 14px;font-size: 14px;">点击领取</a>
                </div>
           ...
           <%  }
              ...
              <div style="height:100px;width:220px;float:right;">
                <div style="float:right;width:20%;height:100%;padding-top:10px;">
                    <a name="yilingqu" href="javascript:error()" style="cursor:pointer;display:inline-block;vertical-align: middle;line-height: 19px;width: 14px;font-size: 14px;">已领取</a>
                </div>
                <div style="float:left;width:80%;height:100%;padding-top:10px;"> 
                  <h3><%=map.getAmount() %>￥</h3>
                  <p><%=map.getName() %></p>
              ...
              <li class="commodity">
                 ...
                 <div style="height:120px;width:98%;margin:0 auto;">
                   ...
                   <p class="commodity_a">
                      ...
                      <a href="${pageContext.request.contextPath}/Kefu_chat2?commodity_id=<%=map.getCommodity_id()%>" target="_blank">
...
<script>
   ...
   shoucang_lan=document.getElementById('shoucang_lan'),
   yincang=document.getElementById('yincang'),
   yincang1=document.getElementById('yincang1'),
   ...
   duizhaolan=document.getElementById('duizhaolan'),
      shoucang_shangpin_lan=document.getElementById('shoucang_shangpin_lan'),
      shoucang_dianpu_lan=document.getElementById('shoucang_dianpu_lan'),
      shoucang_pinpai_lan=document.getElementById('shoucang_pinpai_lan'),
      shoucang_shangpin=document.getElementById('shoucang_shangpin'),
      shoucang_pinpai=document.getElementById('shoucang_pinpai'),
      shoucang_dianpu=document.getElementById('shoucang_dianpu');
   shoucang_shangpin.onclick = function() {
	   shoucang_shangpin_lan.style.display = "block";
	   shoucang_pinpai_lan.style.display = "none";
	   shoucang_dianpu_lan.style.display = "none";
	};
	shoucang_pinpai.onclick = function() {
		   shoucang_shangpin_lan.style.display = "none";
		   shoucang_pinpai_lan.style.display = "block";
		   shoucang_dianpu_lan.style.display = "none";
		};
		shoucang_dianpu.onclick = function() {
			   shoucang_shangpin_lan.style.display = "none";
			   shoucang_pinpai_lan.style.display = "none";
			   shoucang_dianpu_lan.style.display = "block";
			};
...
yincang1.onclick=function(){
	/*self.style.display="block";*/
	shoucang_lan.style.right="-275px";
}
   <%for(int i=1;i<5;i++){%>
...
function qinkong(){
   ...
   <%if(!shoucang_shangpin_list.isEmpty()){
	  ...
	  for(Shoucang_shangpin map:shoucang_shangpin_list){
		  i++;
		  if(i==6) break;%>
		  function my_2<%=map.getId() %>mouseenter(){
			 document.getElementById('shoucang_shangpin_error<%=map.getId()%>').style.display="block";
			 document.getElementById('shoucang_shangpin_jiaru<%=map.getId()%>').style.display="block";
		  }
		  function my_2<%=map.getId() %>mouseleave(){
				 document.getElementById('shoucang_shangpin_error<%=map.getId()%>').style.display="none";
				 document.getElementById('shoucang_shangpin_jiaru<%=map.getId()%>').style.display="none";
			  }
		  <%}}%>
