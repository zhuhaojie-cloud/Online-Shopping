...
<body style="margin:0;padding:0;">
  <div id="gouwuche1" onmouseenter="my_18mouseenter()" onmouseleave="my_18mouseleave()" style="z-index:5;padding:5px;position:absolute;display:none;right:35px;top:30px;width:300px;background:#fff;box-shadow: 0 0 18px rgba(0,0,0,.09);">
   ...
   <div style="width:80%;margin:0 auto;">
     <div style="width:100%;height:30px;background: #cdd;">
        <span style="color: #e3101e;font-size: 20px;"><%=content %></span> >>>  商品筛选  共<%=commodity_infor_list.size() %> 件商品
     </div>
          ...
          <div style="float:right;width:85%;height:100px">
            <ul style="list-style:none;margin:0;" >
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <div class="pinpai_name"><p>苹果</p></div>
                 <div class="pinpai_img"><img src="${pageContext.request.contextPath}/images/phone.png" style="width:100%;height:100%"></div>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/mi.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">小米</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/huawei.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">华为</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/rongyao.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">荣耀</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/sanxing.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">三星</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/meizu.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">魅族</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/vivo.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">vivo</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/meitu.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">美图</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/zhongxin.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">中兴</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/kupai.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">酷派</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/htc.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">HTC</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/motuo.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">摩托罗拉</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/haixin.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">海信</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/lianxiang.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">联想</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/feili.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">飞利浦</p>
              </li>
              <li style="float:left;width:118px;height:48px;background: #cff" class="pinpai">
                 <img class="pinpai_img" src="${pageContext.request.contextPath}/images/nuojiya.png" style="width:100%;height:100%">
                 <p style="display:none;width:78px;height:38px;padding-top:10px;padding-left:40px;" class="pinpai_name">诺基亚</p>
              </li>
            </ul>
          </div>
     ...
     <div>
       ...
       <div style="float:left;width:15%">
          ...
          <div style="width:90%;margin:0 auto;height:75px">
